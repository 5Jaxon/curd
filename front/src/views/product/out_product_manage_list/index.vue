	...
	<div class="table-wrapped">
		<div class="table-top">
			<div class="table-header">
				<div class="search-wrapped" style="display: flex;gap:20px">
					<el-input v-model="productOutId" class="w-50 m-2" placeholder="输入出库编号进行搜索"
						:prefix-icon="Search" @change="searchProductOutId()" clearable @clear="getFirstPageList" />
					<el-input v-model="department" class="w-50 m-2"  placeholder="输入申请部门进行搜索"
						:prefix-icon="Search" @change="searchProductOutDe()" clearable @clear="getFirstPageList" />
			...
			<div class="table-content">
				<el-table :data="tableData" border style="width: 100%;height: 100%;">
					...
					<el-table-column prop="product_out_id" label="出库编号" width="100" />
...
<script lang="ts" setup>
	...
	import {
		searchProductForOutId, returnOutProductListData, getOutProductLength,searchProductForOutDe
	} from '@/api/product.js'
	import {
		Search
	...
	//通过部门搜索
	const searchProductOutDe = async () => {
		tableData.value = await searchProductForOutDe(department.value)
	}
</script>
